...
const columns = [
  ...
  {
      name: 'FirstName' ,
      selector: row => row.firstname,sortable:true,
...
const customStyles = {
  table:{
    style:{
    margin:'auto',
    paddingLeft: '60px', // override the cell padding for data cells
    paddingRight: '60px',
    margin:'auto',
    }
  },
...
createTheme('solarized', {
  ...
  var url = `http://localhost:3333/history?page=${page}&per_page=${perPage}`;
